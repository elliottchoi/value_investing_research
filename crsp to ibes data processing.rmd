...
june_full_database<- FULL_DATABASE %>% filter(month_of_analyst_forecast ==6 & t_minus_one == 'true')
...
distinct_FULL_DATABASE<- FULL_DATABASE %>% distinct(cusip,year_of_analyst_forecast,month_of_analyst_forecast)
# Stats for George 
full_database_from_1980_1996 <- FULL_DATABASE %>% filter(year_of_analyst_forecast<=1996)
full_database_from_1997_2018 <- FULL_DATABASE %>% filter(year_of_analyst_forecast>=1997)
