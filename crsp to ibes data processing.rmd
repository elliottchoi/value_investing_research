...
raw_returns_1980_1996_quartile_one_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_1980_1996_quartile_two_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_1980_1996_quartile_three_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_1980_1996_quartile_four_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
...
# Raw Quartiles for MC 1980_1996 
raw_returns_1980_1996_quartile_one_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_1980_1996_quartile_two_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_1980_1996_quartile_three_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_1980_1996_quartile_four_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
# Excess Quartiles for MC 1980_1996 
...
raw_returns_1997_2018_quartile_one_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_1997_2018_quartile_two_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_1997_2018_quartile_three_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_1997_2018_quartile_four_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
...
# Raw Quartiles for MC 1980_1996 
raw_returns_1997_2018_quartile_one_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_1997_2018_quartile_two_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_1997_2018_quartile_three_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_1997_2018_quartile_four_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
# Excess Quartiles for MC 1980_1996 
...
# Raw Quartiles for MC 1980_1996 
raw_returns_quartile_one_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_quartile_two_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_quartile_three_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_quartile_four_scaled_feps<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
# Excess Quartiles for MC 1980_1996 
...
# Raw Quartiles for MC 1980_1996 
raw_returns_quartile_one_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_one)
raw_returns_quartile_two_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_two)
raw_returns_quartile_three_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_three)
raw_returns_quartile_four_mc<- lm(raw_returns ~ February + March + April + May + June + July + August + September + October + November  +December, data = quartile_four)
# Excess Quartiles for MC 1980_1996 
