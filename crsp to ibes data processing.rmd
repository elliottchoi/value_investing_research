...
ibes_actuals<-ibes_actuals%>%distinct(cusip,pends,.keep_all = TRUE)
```
...
col_order <- c("year_of_analyst_forecast", "month_of_analyst_forecast", "permno","cusip","oftic","monthly_returns","price","shares_outstanding","volume","benchmark_returns","excess_returns","actual_annual_eps","number_of_analyst_predictions","forecast_end_period","analys","f_eps","forecast_standard_deviation","market_capitalization","exchange",'t','t_minus_one','t_plus_one')
FULL_DATABASE<-FULL_DATABASE[,col_order]
# Add average analyst forecast for each month
FULL_DATABASE <- FULL_DATABASE%>%group_by(cusip, year_of_analyst_forecast,month_of_analyst_forecast,forecast_end_period)%>% mutate(average_forecasted_earnings = mean(f_eps))
...
june_full_database<- FULL_DATABASE %>% filter(month_of_analyst_forecast ==6)
col_order <- c("year_of_analyst_forecast", "month_of_analyst_forecast", "permno","cusip","oftic","monthly_returns","price","shares_outstanding","volume","benchmark_returns","excess_returns","actual_annual_eps","number_of_analyst_predictions","forecast_end_period","analys","f_eps","scaled_feps","forecast_standard_deviation","market_capitalization","exchange",'t_plus_one')
june_full_database<- june_full_database[,col_order]
june_full_database<-na.omit(june_full_database)
# Take only one row per company/data
june_full_database<- june_full_database %>% distinct(cusip,month_of_analyst_forecast,.keep_all=TRUE)
# Takes the quartile data of june 1st data by year  
june_full_database<- june_full_database %>% group_by(year_of_analyst_forecast)%>% mutate(quartile_feps = ntile(scaled_feps,4))
june_full_database<- june_full_database %>% group_by(year_of_analyst_forecast)%>% mutate(quartile_market_capitalization = ntile(market_capitalization,4))
...
june_full_database_mapping<- june_full_database[,col_order]
# Match this back to our database 
FULL_DATABASE_v01 <- inner_join(FULL_DATABASE,june_full_database_mapping,by=c('cusip'='cusip', 'forecast_end_period'='forecast_end_period'))
# Get only the distinct rows (E.g. for each month )
distinct_FULL_DATABASE<- FULL_DATABASE_v01 %>% distinct(cusip,year_of_analyst_forecast,month_of_analyst_forecast,.keep_all = TRUE)
# Stats for George 
full_database_from_1980_1996 <- FULL_DATABASE_v01 %>% filter(year_of_analyst_forecast<=1996)
full_database_from_1997_2018 <- FULL_DATABASE_v01 %>% filter(year_of_analyst_forecast>=1997)
...
```{r}
distinct_quartiled_1980_1996 <- distinct_FULL_DATABASE %>% filter(year_of_analyst_forecast<=1996)
first_unique_month_june_stock_database_1980_1996_quartiled <- june_full_database %>% filter(year_of_analyst_forecast<=1996)
distinct_quartiled_1997_2018 <- distinct_FULL_DATABASE %>% filter(year_of_analyst_forecast>=1997)
first_unique_month_june_stock_database_1997_2018_quartiled <- june_full_database %>% filter(year_of_analyst_forecast<=1996)
...
```{r}
# LM for full dataset
full_database_regression_data<-distinct_FULL_DATABASE
...
col_names_for_regression<-c('monthly_returns','excess_returns','February','March','April','May','June','July','August','September','October','November','December','quartile_market_capitalization','quartile_feps')
...
# Raw Return Regression on entire data set 
summary(raw_returns_full_database_regression_model)
summary(raw_returns_full_database_1980_1996_regression_model)
summary(raw_returns_full_database_1997_2018_regression_model)
# Excess Return Regression on entire data set 
summary(excess_returns_full_database_regression_model)
summary(excess_returns_full_database_1980_1996_regression_model)
summary(excess_returns_full_database_1997_2018_regression_model)
# Raw Return Regression from 1980_1996 by mc
summary(raw_returns_1980_1996_quartile_one_mc)
summary(raw_returns_1980_1996_quartile_two_mc)
summary(raw_returns_1980_1996_quartile_three_mc)
summary(raw_returns_1980_1996_quartile_four_mc)
# Excess Return Regression from 1980_1996 by mc
summary(excess_returns_1980_1996_quartile_one_mc)
summary(excess_returns_1980_1996_quartile_two_mc)
summary(excess_returns_1980_1996_quartile_three_mc)
summary(excess_returns_1980_1996_quartile_four_mc)
# Raw Return Regression from 1980_1996 by scaled_feps
summary(raw_returns_1980_1996_quartile_one_scaled_feps)
summary(raw_returns_1980_1996_quartile_two_scaled_feps)
summary(raw_returns_1980_1996_quartile_three_scaled_feps)
summary(raw_returns_1980_1996_quartile_four_mc)
# Excess Return Regression from 1980_1996 by scaled_feps
summary(excess_returns_1980_1996_quartile_one_scaled_feps)
summary(excess_returns_1980_1996_quartile_two_scaled_feps)
summary(excess_returns_1980_1996_quartile_three_scaled_feps)
summary(excess_returns_1980_1996_quartile_four_scaled_feps)

# Raw Return Regression from 1997_2018 by mc
summary(raw_returns_1997_2018_quartile_one_mc)
summary(raw_returns_1997_2018_quartile_two_mc)
summary(raw_returns_1997_2018_quartile_three_mc)
summary(raw_returns_1997_2018_quartile_four_mc)
# Excess Return Regression from 1997_2018 by mc
summary(excess_returns_1997_2018_quartile_one_mc)
summary(excess_returns_1997_2018_quartile_two_mc)
summary(excess_returns_1997_2018_quartile_three_mc)
summary(excess_returns_1997_2018_quartile_four_mc)
# Raw Return Regression from 1997_2018 by scaled feps
summary(raw_returns_1997_2018_quartile_one_scaled_feps)
summary(raw_returns_1997_2018_quartile_two_scaled_feps)
summary(raw_returns_1997_2018_quartile_three_scaled_feps)
summary(raw_returns_1997_2018_quartile_four_mc)
# Excess Return Regression from 1997_2018 by scaled feps
summary(excess_returns_1997_2018_quartile_one_scaled_feps)
summary(excess_returns_1997_2018_quartile_two_scaled_feps)
summary(excess_returns_1997_2018_quartile_three_scaled_feps)
summary(excess_returns_1997_2018_quartile_four_scaled_feps)

# Raw Return Regression for all by mc
summary(raw_returns_quartile_one_mc)
summary(raw_returns_quartile_two_mc)
summary(raw_returns_quartile_three_mc)
summary(raw_returns_quartile_four_mc)
# Excess Return Regression for all by mc
summary(excess_returns_quartile_one_mc)
summary(excess_returns_quartile_two_mc)
summary(excess_returns_quartile_three_mc)
summary(excess_returns_quartile_four_mc)
# Raw Return Regression for all by scaled feps
summary(raw_returns_quartile_one_scaled_feps)
summary(raw_returns_quartile_two_scaled_feps)
summary(raw_returns_quartile_three_scaled_feps)
summary(raw_returns_quartile_four_mc)
# Excess Return Regression for all by scaled feps
summary(excess_returns_quartile_one_scaled_feps)
summary(excess_returns_quartile_two_scaled_feps)
summary(excess_returns_quartile_three_scaled_feps)
summary(excess_returns_quartile_four_scaled_feps)
```
...
raw_return_regression_p_stat_table_1980_1996<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(raw_return_regression_p_stat_table_1980_1996) <- x
rownames(raw_return_regression_p_stat_table_1980_1996)<-y
# Overall
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
excess_return_regression_p_stat_table_1980_1996<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(excess_return_regression_p_stat_table_1980_1996) <- x
rownames(excess_return_regression_p_stat_table_1980_1996)<-y
# Overall
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
raw_return_regression_p_stat_table_1980_1996_by_mc<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(raw_return_regression_p_stat_table_1980_1996_by_mc) <- x
rownames(raw_return_regression_p_stat_table_1980_1996_by_mc)<-y
# Overall
temp_coeff<-coef(raw_returns_full_database_1980_1996_regression_model)
temp_t_stat<-summary(raw_returns_full_database_1980_1996_regression_model)[["coefficients"]][, "t value"]
temp_p_stat<-summary(raw_returns_full_database_1980_1996_regression_model)[["coefficients"]][, 4]
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996_by_mc[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996_by_mc[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996_by_mc[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996_by_mc[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1980_1996_by_mc[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
excess_return_regression_p_stat_table_1980_1996_by_mc<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(excess_return_regression_p_stat_table_1980_1996_by_mc) <- x
rownames(excess_return_regression_p_stat_table_1980_1996_by_mc)<-y
# Overall
temp_coeff<-coef(excess_returns_full_database_1980_1996_regression_model)
temp_t_stat<-summary(excess_returns_full_database_1980_1996_regression_model)[["coefficients"]][, "t value"]
temp_p_stat<-summary(excess_returns_full_database_1980_1996_regression_model)[["coefficients"]][, 4]
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996_by_mc[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996_by_mc[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996_by_mc[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996_by_mc[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1980_1996_by_mc[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
raw_return_regression_p_stat_table_1997_2018<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(raw_return_regression_p_stat_table_1997_2018) <- x
rownames(raw_return_regression_p_stat_table_1997_2018)<-y
# Overall
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
excess_return_regression_p_stat_table_1997_2018<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(excess_return_regression_p_stat_table_1997_2018) <- x
rownames(excess_return_regression_p_stat_table_1997_2018)<-y
# Overall
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
raw_return_regression_p_stat_table_1997_2018_by_mc<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(raw_return_regression_p_stat_table_1997_2018_by_mc) <- x
rownames(raw_return_regression_p_stat_table_1997_2018_by_mc)<-y
# Overall
temp_coeff<-coef(raw_returns_full_database_1997_2018_regression_model)
temp_t_stat<-summary(raw_returns_full_database_1997_2018_regression_model)[["coefficients"]][, "t value"]
temp_p_stat<-summary(raw_returns_full_database_1997_2018_regression_model)[["coefficients"]][, 4]
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018_by_mc[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018_by_mc[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018_by_mc[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018_by_mc[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  raw_return_regression_p_stat_table_1997_2018_by_mc[index,5]<-temp_t_stat[index]
}
...
# Creation of the p_stat_table 
excess_return_regression_p_stat_table_1997_2018_by_mc<- data.frame(matrix(ncol = 5, nrow = 12))
colnames(excess_return_regression_p_stat_table_1997_2018_by_mc) <- x
rownames(excess_return_regression_p_stat_table_1997_2018_by_mc)<-y
# Overall
temp_coeff<-coef(excess_returns_full_database_1997_2018_regression_model)
temp_t_stat<-summary(excess_returns_full_database_1997_2018_regression_model)[["coefficients"]][, "t value"]
temp_p_stat<-summary(excess_returns_full_database_1997_2018_regression_model)[["coefficients"]][, 4]
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018_by_mc[index,1]<-temp_t_stat[index]
}
# Quartile One
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018_by_mc[index,2]<-temp_t_stat[index]
}
# Quartile two
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018_by_mc[index,3]<-temp_t_stat[index]
}
# Quartile Three
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018_by_mc[index,4]<-temp_t_stat[index]
}
# Quartile Four
...
for(index in 1:length(temp_coeff)){
  ...
  excess_return_regression_p_stat_table_1997_2018_by_mc[index,5]<-temp_t_stat[index]
}
