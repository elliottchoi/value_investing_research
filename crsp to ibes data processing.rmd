...
y <- c('January','February','March','April','May','June','July','August','September','October','November','December','F_Statistic','Chi-Squared_Test')
...
raw_return_regression_p_stat_table_1980_1996<- data.frame(matrix(ncol = 5, nrow = 14))
...
raw_return_regression_p_stat_table_1980_1996[13,1]<-
