...
raw_return_regression_coeff_table_1980_1996<- data.frame(matrix(ncol = 5, nrow = 14))
...
raw_return_regression_t_stat_table_1980_1996<- data.frame(matrix(ncol = 5, nrow = 14))
