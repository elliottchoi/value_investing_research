...
col_order <- c('cusip','forecast_end_period','quartile_feps','quartile_market_capitalization','year_of_analyst_forecast')
june_full_database_mapping<- june_full_database[,col_order]
# Match this back to our database 
FULL_DATABASE_v01 <- inner_join(FULL_DATABASE,june_full_database_mapping,by=c('cusip'='cusip', 'forecast_end_period'='forecast_end_period','year_of_analyst_forecast'='year_of_analyst_forecast'))
